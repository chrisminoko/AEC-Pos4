...
namespace AEC_Pos.Controllers
{
    public class GoodsReceivesController : Controller
    {
        ...
        public GoodsReceivesController(ApplicationDbContext context)
        {
            _context = context;
        }
